  ...
  return (
    <div className="bg-white rounded-lg shadow-2xl w-full max-w-6xl max-h-[90vh] overflow-hidden flex flex-col">
      ...
      <div className="bg-blue-600 px-6 py-4 flex items-center justify-between">
        ...
        <button
          onClick={onClose}
          className="text-white p-1 rounded-full hover:bg-gray-50/25 text-2xl font-bold transition cursor-pointer"
        >
          <X/>
        </button>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="h-auto border border-gray-200 rounded-lg shadow-sm p-4 overflow-auto">
              {loading ? (
                <LoadingSpinner />
              ) : resultado ? (
      ...
      {/* Footer */}
      <div className="bg-white px-6 py-4 flex justify-end gap-3 border-t border-gray-300">
        <button
          onClick={onClose}
