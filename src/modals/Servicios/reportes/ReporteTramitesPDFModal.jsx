// 📁 components/reportes/ModalReporteListas.jsx
...
export default function ReporteTramitesPDFModal ({ onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    await descargarPDFListas(formData);
  };
    ...
    <div className="bg-white rounded-lg shadow-2xl w-full max-w-6xl max-h-[90vh] overflow-hidden flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-6">
        <div className="bg-blue-600 text-white px-4 py-2 rounded shadow-md w-2/3 mx-auto mb-6">
          <h5 className="text-center font-semibold">Reportes en PDF</h5>
        </div>
